...
(define-judgment-form TypeSystem
  #:mode (ts I I I I O)
  #:contract (ts ilist pc i cstk cstk) ;; b means that a char is mandatory

  [
   (where pc_1 (sum pc 1))
   (where i_1 (fetch-i ilist pc_1))

   (ts ilist pc_1 i_1 () cstk_1)
   ---------------------------------------------------------------------- "T-char"
   (ts ilist pc (char ch) () cstk_1)
   ]
  ...
  [
   ...
   (ts ilist pc_1 i_1 (ce ... (p #t)) cstk_1)
   ---------------------------------------------------------------------- "T-char-pop"
   (ts ilist pc (char ch) (ce ... (p bc)) cstk_1)
   ]
  ...
  [
   ...
   (ts ilist pc_2 i_2 (ce ... (pc_0 #f)) cstk_1) ;; stk set and goto next
   -------------------------------------------------------------------- "T-choice-prev-negative"
   (ts ilist pc (choice l) (ce ...) cstk_1)
   ]
   ...
   (ts ilist pc_1 i_1 cstk cstk_1)
   (ts ilist pc_2 i_2 cstk cstk_2)

   (where cstk_3 (merge-choice cstk_1 cstk_2))
   -------------------------------------------------------------------- "T-choice"
   (ts ilist pc (choice l) cstk cstk_3)
   ]
  ...
  [
   ...
   (ts ilist pc_1 i_1 (ce ...) cstk_1)
   -------------------------------------------------------------------- "T-commit-negative"
   (ts ilist pc (commit l) (ce ... (pc #t)) cstk_1)
   ]
  ...
  [
   ...
   (ts ilist pc_1 i_1 cstk cstk_1)
   -------------------------------------------------------------------- "T-commit"
   (ts ilist pc (commit l) cstk cstk_1)
   ]
  ...
  [
   ...
   (ts ilist pc_1 i_1 (ce ... (p bc)) cstk_1)
   ---------------------------------------------------------------------- "T-fail-pop"
   (ts ilist pc fail (ce ... (p bc)) cstk_1)
   ]

  [
   ---------------------------------------------------------------------- "T-return"
   (ts ilist pc return cstk cstk)
   ]
  ...
  [
   ...
   (ts ilist pc_2 i_2 cstk_1 cstk_2)
   ---------------------------------------------------------------------- "T-call"
   (ts ilist pc (call l) cstk cstk_2)
   ]
)
