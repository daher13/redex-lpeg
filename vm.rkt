...
(define-judgment-form
 ...
 [
  ---------------------------------"T-char"
  (types ilist pc (char ch) stk false)
  ]

 [
  (types ilist l (fetch-i ilist (add pc l)) stk t_1)
  -------------------------------------------------------- "T-jump"
  (types ilist pc (jump l) stk t_1)
  ]

 [
  (types ilist l (fetch-i ilist (add pc l)) stk t_1)
  -------------------------------------------------------- "T-commit"
  (types ilist pc (commit l) stk t_1)
  ]

 [
  (types ilist (add pc 1) (fetch-i ilist (add pc 1)) stk t)
  ------------------------------------------------------ "T-choice"
  (types ilist pc (choice l) stk t)
  ]

 [
  ------------------------------------------------------ "T-end"
  (types ilist pc end stk true)
  ]
...
;; ilist
(define pc 0)
;; (define i (term (fetch-i ,ilist ,pc)))
;; (judgment-holds (types ,ilist ,pc ,i true))
;; (define s '(3))
;; (define state
;; (term (
;; ,ilist
